...
1. **Access Security Settings:** In your Coolify dashboard click your `profile icon → Two-factor Authentication`.
2. **Enable 2FA:** Scan the QR code with an authenticator app ([Google Authenticator](https://play.google.com/store/apps/details?id=com.google.android.apps.authenticator2), [Authy](https://authy.com/), or [Microsoft Authenticator](https://www.microsoft.com/en-us/security/mobile-authenticator)).
