...
<!-- TOC -->
  * [Elija un proveedor de VPS](#elija-un-proveedor-de-vps)
    ...
    * [Elija un sistema operativo y configure una contraseña y SSH](#elija-un-sistema-operativo-y-configure-una-contraseña-y-ssh)
...
### Elija un sistema operativo y configure una contraseña y SSH

Luego de obtener la instancia, elige un sistema operativo: yo voy a elegir Ubuntu 24.04, ya que es uno de los sistemas operativos más comunes al configurar un VPS.

![hostinger-select-os](/uploads/2025-01-28-vps-2/hostinger-select-os.png)

_Por cierto, **no** uso Arch_.

En la siguiente pantalla, se ofrece un escáner de malware. Lo dejé habilitado, ya que parece ser liviano y gratuito
![hostinger-malware-scanner](/uploads/2025-01-28-vps-2/hostinger-malware-scanner.png)

Luego, configure una contraseña para el usuario root.
- Agregue también una clave SSH para poder iniciar sesión más tarde a través de SSH.
- Hostinger te proporcionará instrucciones sobre cómo generar y agregar una clave SSH.
...
Puede encontrar la dirección IP de su instancia VPS en la pantalla "Descripción general -> Información del VPS". A partir de ahora, utilizaré la dirección IP de mi VPS en los ejemplos.
