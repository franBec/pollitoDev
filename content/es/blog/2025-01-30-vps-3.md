...
1. **Acceda a la configuración de seguridad:** En el panel de Coolify, haz clic en el `ícono de tu perfil → Autenticación de dos factores`.
2. **Habilite 2FA:** Escanea el código QR con una aplicación de autenticación ([Google Authenticator](https://play.google.com/store/apps/details?id=com.google.android.apps.authenticator2), [Authy](https://authy.com/) o [Microsoft Authenticator](https://www.microsoft.com/en-us/security/mobile-authenticator)).
